...
# Importation Dataset
df = pd.read_csv('code/E_Business/dataset_E_Business.csv')
...
Master_Moy_M1 = pd.cut(x=df['Master_Moy_S1_S2'], bins=[0, 9, 10, 11, 12, 13, 14, 20])
Master_Moy_M2 = pd.cut(x=df['Master_Moy_S3'], bins=[0, 10, 11, 12, 13, 14, 15, 20])
...
pickle.dump(knn, open('code/E_Business/Model_M1_E_Business.pkl','wb'))
...
# accuracy
print("Accuracy = ",accuracy_score(y,predictions))
pickle.dump(knn, open('code/E_Business/Model_M2_E_Business.pkl','wb'))
